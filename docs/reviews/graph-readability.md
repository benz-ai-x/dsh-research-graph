...
针对用户截图中的 9 条讨论，修复分支重复汇聚连线、簇标题迫使连线绕远、独立资料散排、同名节点难以辨认，以及子代理只有计数无法查看的问题。工作区图谱和跨工作区主题共用这些修复。首次本地验收构建为 **0.1.5-rc.2.7 · local-b6782883**；改号后的实包验证见 [0.1.5-rc.2.8 发布验收](release-0.1.5-rc.2.8.md)。
